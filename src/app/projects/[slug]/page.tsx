  ...
  return (
    <main className="min-h-screen bg-off-white text-charcoal">
      ...
      <section className="relative h-[90vh] flex items-center overflow-hidden bg-charcoal pt-20">
        ...
        <div className="absolute inset-0 z-0 opacity-20 video-container">
          {project.videoUrl ? (
            <video
              ref={videoRef}
        ...
        <div className="absolute inset-0 z-10 pointer-events-none" 
          style={{ background: `radial-gradient(ellipse at center, transparent 0%, rgba(13,13,13,0.8) 100%)` }} 
        />
        ...
        <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 hero-element">
          <span className="font-mono text-[9px] tracking-[0.4em] uppercase text-off-white/30">explore</span>
      ...
      <section className="py-32 px-6 md:px-12" ref={contentRef}>
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-24">
          ...
          <div className="space-y-16 sticky top-32 h-fit">
            <div className="detail-section">
              <p className="font-mono text-[10px] tracking-[0.4em] uppercase text-amber mb-8">Tech Stack</p>
              <div className="flex flex-wrap gap-3">
                {project.tags.map((tag) => (
                  <span key={tag} className="font-mono text-xs tracking-wider px-5 py-2 rounded-xl border border-charcoal/10 bg-white shadow-sm">
                    {tag}
                  </span>
                ))}
              </div>
      ...
      <section className="py-40 px-6 md:px-12 bg-bone/20 border-t border-charcoal/5">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center items-center gap-6">
            ...
            <Link href="/" className="font-mono text-xs tracking-widest uppercase hover:text-amber transition-colors">Home</Link>
            <div className="h-px w-20 bg-charcoal/10" />
          </div>
        </div>
      </section>
